        ...
        try:
            ...
            for movie in data.get("results", []):
                ...
                if movie.get("backdrop_path"):
                    movie["backdrop_url"] = self.get_image_url(movie["backdrop_path"], "w1280")
    ...
    async def get_movie_details(self, tmdb_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if data.get("backdrop_path"):
                data["backdrop_url"] = self.get_image_url(data["backdrop_path"], "w1280")
        ...
        if movie_data.get("tmdb_id"):
            ...
            if details:
                ...
                enriched_data.update({
                    ...
                    "tmdb_production_companies": details.get("production_company_names", [])
                })
...
class TMDBServiceManager:
    ...
    def get_instance(cls) -> TMDBService:
        ...
        if cls._instance is None:
            raise RuntimeError("TMDB service not initialized. Call TMDBServiceManager.initialize() first.")
        return cls._instance
