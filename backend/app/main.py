...
app = FastAPI(
    ...
    A comprehensive REST API for managing physical media collections and their storage locations.
    Perfect for collectors who want to organize and track their DVD, Blu-ray, and digital movie collections.
    ...
    **Paginated Response:**
    ...
    - **TMDB API**: Movie metadata provided by [The Movie Database](https://www.themoviedb.org/)
    ...
    openapi_tags=[
        ...
        {
            "name": "movies",
            "description": "Movie collection management operations including CRUD, search, and TMDB integration",
            "externalDocs": {
        ...
        {
            "name": "storage",
            "description": "Storage container management operations for organizing your physical media",
            "externalDocs": {
